    ...
    <div className={s.container}>
      ...
      <div className={s.main_column}>
        <div className={s.control_container} style={{ textAlign: 'center' }}>
          <h1 className={s.header}>Assignment 1</h1>
          ...
          <div className={s.text}>
            ...
            nobots parade down York street outside the Leeds studio. click below
            to load it up!
          </div>
        ...
        <div className={s.control_container}>
          ...
          <div className={s.text}>
            ...
            open two browser windows and fullscreen them in both triads of
            displays. this can be done easily by using:
          </div>
